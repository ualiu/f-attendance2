...
StaffLogix is an AI-powered attendance system for shift-based teams. Employees report absences by SMS; an LLM parses the message into a structured record over a multi-turn conversation. Supervisors manage employees, notes and reports through a web dashboard.
